//
//  VattnaAPIClient.swift
//  Vattna
//
//  API client for communicating with the Vattna server
//

import Foundation

/// API client for communicating with the Vattna server
actor VattnaAPIClient {

    // MARK: - Singleton

    static let shared = VattnaAPIClient()
    ...
    private init() {
        ...
        AppLogger.network.info("VattnaAPIClient initialized")
    }
