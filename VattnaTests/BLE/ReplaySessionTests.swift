...
//  *.ble-session.json file. Drop it into VattnaTests/BLE/Recordings/,
...
struct ReplayFixture: Sendable, CustomTestStringConvertible {
    /// Full file name in VattnaTests/BLE/Recordings/
    let fileName: String
...
struct ReplaySessionTests {
    ...
    func recordReplayRoundTrip() async throws {
        ...
        let artifact = FileManager.default.temporaryDirectory
            .appendingPathComponent("vattna-synthetic-fixture.ble-session.json")
