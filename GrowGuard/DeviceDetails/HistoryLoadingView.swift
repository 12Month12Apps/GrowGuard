...
struct HistoryLoadingView: View {
    ...
    @State private var loadingState: HistoryLoadingState = .idle
    @State private var showingDetails: Bool = false
    @State private var connectionQuality: HistoryConnectionQuality = .unknown
    ...
    private func setupSubscribers() {
        AppLogger.ble.info("📡 HistoryLoadingView: Setting up ConnectionPool subscribers")
